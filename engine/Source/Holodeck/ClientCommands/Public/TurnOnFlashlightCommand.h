...
* 	- Flashlight name, Light intensity, Beam width, Light location (x), Light location (y), Light location (z), 
      Light angle (Pitch), Light angle (Yaw), Light color (R Component), Light color (G Component), Light color (B Component).
*/
