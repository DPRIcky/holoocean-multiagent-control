...
class FlashlightController:
    ...
    def __init__(self, client, flashlight_name, intensity, beam_width, location_x_offset, location_y_offset, location_z_offset, angle_pitch, angle_yaw, color_R, color_G, color_B):
        self._client = client
    ...
    def set_flashlight(self):
        self._client.command_center.enqueue_command(TurnOnFlashlightCommand(self.flashlight_name, self.intensity, self.beam_width, self.location_x_offset, self.location_y_offset, self.location_z_offset, self.angle_pitch, self.angle_yaw, self.color_R, self.color_G, self.color_B))