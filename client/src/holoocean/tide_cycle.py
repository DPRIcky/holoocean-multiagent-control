...
class TideController:
    ...
    def __init__(self, client, amplitude = 100.0, frequency = 2000, tide_type = 'TideNormal', active = 0):
    ...
    def get_height(self):
        ...
        if self.tide_type == 'TideNormal':
            return (self.amplitude * numpy.sin(((2 * numpy.pi) / self.frequency) * sim_age))
